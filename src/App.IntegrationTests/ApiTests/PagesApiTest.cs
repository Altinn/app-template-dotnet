...
namespace App.IntegrationTestsRef.ApiTests
{
    ...
    /// </summary>
    public class PagesApiTest : IClassFixture<CustomWebApplicationFactory<Altinn.App.AppLogic.AppModel>>
    {
        private readonly CustomWebApplicationFactory<Altinn.App.AppLogic.AppModel> _factory;

        public PagesApiTest(CustomWebApplicationFactory<Altinn.App.AppLogic.AppModel> factory)
        {
            _factory = factory;
        }
